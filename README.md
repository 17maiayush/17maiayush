...
**Backend Engineer (SDE-1) @ GoKwik | Distributed Systems & Real-Time Pipelines | Kafka, Go | Node.js | Agentic AI (MCP, LLMs)**
...
- **Multi-tenant infra** — security-aware backends serving 12,000+ merchants, IDOR remediation, cross-tenant isolation
